	...
	<div id="container">
		...
		<div id="header">
			<div class="header_left">
				<div id="site_logo">
					<span>Obitelj Purnikovic - Arso i Masha Putnikovic</span>
				</div>
			</div>
			...
			<div id="links_2">
				<a href="https://www.facebook.com/zlanusic"><img
					alt="rss feed"
					src="css/images/Links_pics/followFacebook.jpg"/>
				</a> <a href="https://twitter.com/zlanusic"><img
					alt="rss feed"
					src="css/images/Links_pics/twitter_link.jpg"/>
				</a>
			</div>
		</div>
		<div id="content"></div>
