...
jQuery.fn.bxSlider = function(options){
	...
	function add_controls(){
		...
		*/
		$this.parent().find('.slider_prev').css({'position':'absolute', 'top':'2px', 'left':'5px',  'outline':'0'});
		$this.parent().find('.slider_next').css({'position':'absolute', 'top':'2px', 'right':'5px', 'outline':'0'});
